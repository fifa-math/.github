...
This public repository is the canonical source for GitHub-supported community-health fallbacks, organization profile content, contribution guidance, public security/support policy, issue and pull-request templates, and agent-governance declarations for [`fifa-math`](https://github.com/fifa-math).

## Canonical organization links

- GitHub organization: https://github.com/fifa-math
- Public organization defaults: https://github.com/fifa-math/.github
